...
[VARPred, VARIndex, removedlagAllTr, removedlagAllT] = revLagSubsetGP(VARDivergence, minNumLags, numTotalLags, GPParam, numForceValues, lagAllTr, ftrAdjusted, lagAllT);
