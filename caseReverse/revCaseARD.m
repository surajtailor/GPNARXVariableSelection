...
[ARDPred, ARDIndex, removedlagAllTr, removedlagAllT] = revLagSubsetGP(ARDRelevances, minNumLags, numTotalLags, GPParam, numForceValues, lagAllTr, ftrAdjusted, lagAllT);
