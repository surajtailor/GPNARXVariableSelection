...
[ARDPred, ARDIndex, removedlagAllTr, removedlagAllT, ARDData] = optARDLagSubsetGP(ARDRelevances, minNumLags, numTotalLags, GPParam, numForceValues, lagAllTr, ftrAdjusted, lagAllT, lagAllV, fvAdjusted, ARDData);
