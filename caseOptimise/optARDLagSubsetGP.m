...
function [pred, index, lagAllTr, lagAllT, ARDData] = optARDLagSubsetGP(divergence, minNumLags, numTotalLags, GPParam, numForceValues, lagAllTr, ftrAdjusted, lagAllT, lagAllV, fvAdjusted, ARDData)
