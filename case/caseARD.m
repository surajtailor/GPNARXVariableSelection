...
ARDData.allLagData = {lagAllTr; lagAllV; lagAllT};
ARDData.allTargetData = {ftrAdjusted; fvAdjusted; ftAdjusted};
...
ARDLocalMin = minimize(tempHyp, @gp, -10000, @infGaussLik, ARDParam.meanfunc, ARDParam.covfunc, ARDParam.likfunc, lagAllV, fvAdjusted);
...
[ARDPred, ARDIndex, removedlagAllTr, removedlagAllT] = lagSubsetGP(ARDRelevances, minNumLags, numTotalLags, GPParam, numForceValues, lagAllTr, ftrAdjusted, lagAllT);
