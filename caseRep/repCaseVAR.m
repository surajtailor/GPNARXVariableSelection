...
[VARPred, VARIndex, removedlagAllTr, removedlagAllT, VARData] = repVARLagSubsetGP(VARDivergence, minNumLags, numTotalLags, GPParam, numForceValues, lagAllTr, ftrAdjusted, lagAllT, lagAllV, fvAdjusted, VARData);
