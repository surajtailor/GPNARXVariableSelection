...
function [pred, index, lagAllTr, lagAllT, ARDData] = repARDLagSubsetGP(divergence, minNumLags, numTotalLags, GPParam, numForceValues, lagAllTr, ftrAdjusted, lagAllT, lagAllV, fvAdjusted, ARDData)
...
numIter = 5;
divergence = repARDRelFunction(numIter, ARDData.ARDParam, lagAllV, fvAdjusted, lagCounter);
ARDData.subsetARDDiv{i,1} = divergence;
