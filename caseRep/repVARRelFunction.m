function varRelevances = repVARRelFunction(nquadr, condNum, GPParam, lagAllTr, ftrAdjusted, lagAllV, repMin)
%Checked :)
...
for j = 1:XNumCols%
    ...
    for k = 1:XNumRows
        ...
        [predMean, ~] = gp(repMin, @infGaussLik, GPParam.meanfunc, GPParam.covfunc, GPParam.likfunc, lagAllTr, ftrAdjusted, fCalcPoints);%
