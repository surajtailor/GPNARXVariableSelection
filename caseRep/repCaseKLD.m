...
[KLDPred, KLDIndex, removedlagAllTr, removedlagAllT, KLDData] = repKLDLagSubsetGP(KLDivergence, minNumLags, numTotalLags, GPParam, numForceValues, lagAllTr, ftrAdjusted, lagAllT, lagAllV, fvAdjusted, KLDData);
