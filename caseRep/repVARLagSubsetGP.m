...
function [pred, index, lagAllTr, lagAllT, VARData] = repVARLagSubsetGP(divergence, minNumLags, numTotalLags, GPParam, numForceValues, lagAllTr, ftrAdjusted, lagAllT, lagAllV, fvAdjusted, VARData)
...
%% VARRelFunction
nquadr = lagCounter*3 + 2;
condNum = 10;
divergence = repVARRelFunction(nquadr, condNum, GPParam, lagAllTr, ftrAdjusted, lagAllV, repMin);

VARData.subsetVARDiv{i,1} = divergence;
...
% MPO
MPOPred = repMPOFunction(numForceValues, GPParam, lagAllTr, ftrAdjusted, lagAllT, repMin);
