...
function [pred, index, lagAllTr, lagAllT, KLDData] = repKLDLagSubsetGP(divergence, minNumLags, numTotalLags, GPParam, numForceValues, lagAllTr, ftrAdjusted, lagAllT, lagAllV, fvAdjusted, KLDData)
...
delta = 10^(-4);
divergence = KLDFunction2(delta, GPParam, lagAllTr, ftrAdjusted, lagAllV);
KLDData.subsetKLDDiv{i,1} = divergence;
