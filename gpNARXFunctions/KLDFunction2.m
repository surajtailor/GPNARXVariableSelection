...
% analyed
%Checked :)
function relevances = KLDFunction2(delta, GPParam ,lagAllTr, ftrAdjusted, lagAllV)
...
for j = 1:XNumRows%
   ...
   for dim = 1:XNumCols%
       ...
       [predDeltaMean, predDeltaVar] = gp(GPParam.globalMin, @infGaussLik, GPParam.meanfunc, GPParam.covfunc, GPParam.likfunc, lagAllTr, ftrAdjusted, x_n');%
